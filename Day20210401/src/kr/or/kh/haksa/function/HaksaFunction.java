package kr.or.kh.haksa.function;
...
public class HaksaFunction { //클래스의 시작
	public static void register(int cnt, Scanner input, ArrayList<HashMap<String, String>> haksaList) { //등록 함수 시작
	...
	public static void search(Scanner input, ArrayList<HashMap<String, String>> haksaList ) { //검색함수시작
		String object="";
		String nameSearch = "";
	...
	public static void delete(Scanner input, ArrayList<HashMap<String, String>> haksaList) { //삭제함수
		String nameDelete ="";
		String object = "";
	...
	public static void list(ArrayList<HashMap<String, String>> haksaList) { //전체 출력함수 시작 
	...
	public static String update(Scanner input, ArrayList<HashMap<String, String>> haksaList) {  //정보 수정 함수 
