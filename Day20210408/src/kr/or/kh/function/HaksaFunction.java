...
public class HaksaFunction {
	...
	public static void search(int cnt, Scanner input, ArrayList<HashMap<String, String>> haksaList) {
	...
	public static void delete(int cnt, Scanner input, ArrayList<HashMap<String, String>> haksaList) {
