...
public class TestMain {
	...
	public void createStudent() {
		Student student1 = new Student(211213,"제니", korean);
		Student student2 = new Student(210932,"리사", math);
		Student student3 = new Student(213204,"핑크", korean);
		Student student4 = new Student(204821,"지수", korean);
		Student student5 = new Student(202932,"로제", math);
